...
RSpec.describe Wallet, type: :model do
  ...
  describe "btc_total" do
    it "calculates btc total when buy" do
    ...
    it "calculates btc total when sell" do
      wallet = FactoryGirl.create(:wallet, balance_usd: 0.0)
      trade = FactoryGirl.create(:trade, amount: 1, price: 500.0, trade_type: "sell", wallet: wallet)

      expect(trade.wallet.btc_total).to eql(-1)
    end
  end
